...
@view_config(route_name='index', renderer='templates/base.jinja2')
def index(request):
    return {}
...
def lista_clientes(request):
    nome,data_nascimento,sexo,estado_civil = request.GET['nome'], request.GET['data_nascimento'],request.GET['sexo'],request.GET['estado_civil']
...
def inclui_cliente(request):
    nome,data_nascimento,sexo,estado_civil = request.json_body['nome'],request.json_body['data_nascimento'],request.json_body['sexo'],request.json_body['estado_civil']
